...
if choice1 == "left":
    choice2 = ('You\'ve come to a lake, there is an island in the middle of the lake. '
               'Type "wait" to wait for a boat. Type "swim" to swim across.').lower()
    if choice2 == "wait":
        choice3 = ("You arrive at the island unharmed. "
                   "There is house with 3 doors. One red, one yellow and one blue. Which color do you choose?").lower()
        if choice3 == "red":
