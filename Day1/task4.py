...
name = "Raj"
print(name) # here variable - name will take value from name = Raj

# first input() part will executed then the len() function will calculate the length of the string and print() function prints the length of string
