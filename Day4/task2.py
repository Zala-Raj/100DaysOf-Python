...
print(states_of_america) # output: ['Delaware', 'Pennsylvania', 'Georgia']

states_of_america.extend(["New Jersey", "New York"])
print(states_of_america) # output: ['Delaware', 'Pennsylvania', 'Georgia', 'New Jersey', 'New York']